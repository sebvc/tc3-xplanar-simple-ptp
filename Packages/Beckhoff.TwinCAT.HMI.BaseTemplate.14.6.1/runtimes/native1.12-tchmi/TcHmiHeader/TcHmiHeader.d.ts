...
declare class TcHmiHeader extends TcHmi.Controls.System.TcHmiControl {
    ...
    protected __headerItems: IHeaderItems[] | undefined | null;
    /** Structure which contains header element data */
     ...
     */
    protected __onResolverForHeaderItemsWatchCallback(data: ObjectResolver.IWatchResultObject<IHeaderItems[] | null>): void;
    /**
     * Returns the current headerItems value.
     */
    getHeaderItems(): IHeaderItems[] | null | undefined;
    /**
