...
declare class TcHmiTachometer extends TcHmi.Controls.System.TcHmiControl {
    ...
    protected __needleColor: SolidColor | null | undefined;
    /** Internal reference to the attribute 'data-tchmi-start-position' */
     ...
     */
    protected __onResolverForNeedleColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
    /**
