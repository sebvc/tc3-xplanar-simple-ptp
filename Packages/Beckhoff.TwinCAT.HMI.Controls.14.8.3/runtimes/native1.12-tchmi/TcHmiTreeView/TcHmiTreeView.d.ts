...
declare class TcHmiTreeView extends TcHmi.Controls.System.TcHmiControl {
    ...
    __previnit(): void;
    /**
     * Pointer gesture arbitration: the tree view builds its own cell editor inputs (text box, numeric, spinbox,
     * password, timespan, ...). Take ownership of a left-button drag that starts on an editable text input/textarea so
     * the user can select its text with the mouse instead of an enclosing zoom/pan region taking the drag over as a
     * pan. Checkboxes and radio buttons are ignored since dragging on them is not a text selection.
    ...
    protected __getColumnControlInfoByEditorInfo(editorInfo: Editor.EditorInfo | undefined): {
        columnControl: "CheckBox" | "ComboBox" | "DateTimeInput" | "HTMLElement" | "NumericInput" | "SpinboxInput" | "TextBlock" | "TextBox" | "TimespanInput";
     ...
     * @returns the current value of the member variable text.
     */
    getColumns(): Column[] | SimpleColumn | undefined;
    /**
