...
export declare class ManageUserPopup extends UserManagementPopup {
    ...
    protected __updateFontSizes(): void;
    /**
     * Forwards the system keyboard input mode to all sub popups with username inputs.
     */
    protected __updateSystemKeyboardUsernameInputMode(): void;
    /**
     * Forwards the system keyboard input mode to all sub popups with password inputs.
     */
    protected __updateSystemKeyboardPasswordInputMode(): void;
    /**
     * Sets texts which can either be localizable or static.
