...
export declare class DirectoryBrowser<TFile, TFolder> {
    ...
    protected __parentControl: TcHmiControl.Control | undefined;
     ...
     * @param parentControl The control that uses this directory browser.
     */
    constructor(displays: Iterable<Display>, parentControl?: TcHmiControl.Control);
    /**
     * Adds a display.
     ...
     * @param getMetadata A function that returns metadata about the given file or folder.
     */
    protected buildDirectoryTree(rootFolder: TFolder, getChildren: (folder: TFolder) => Map<string, TFile | TFolder>, isFile: (candidate: TFile | TFolder) => candidate is TFile, getMetadata?: (item: TFile | TFolder) => Dictionary<any>): _DirectoryBrowser.Root<TFile, TFolder>;
}
...
export declare abstract class Display {
     ...
     */
    constructor(__element: HTMLElement, __parentControl: TcHmiControl.Control);
    /**
     * Removes all event listeners. Should be called when the owning control is detached or destroyed.
...
export declare abstract class DragAndDropDisplay extends Display {
     ...
     */
    constructor(element: HTMLElement, parentControl: TcHmiControl.Control);
    /**
...
export declare class ListBrowsingDisplay extends Display {
     ...
     */
    constructor(element: HTMLUListElement, parentControl: TcHmiControl.Control);
    /**
...
export declare class PathDisplay extends Display {
     ...
     */
    constructor(element: HTMLDivElement, parentControl: TcHmiControl.Control);
    /**
