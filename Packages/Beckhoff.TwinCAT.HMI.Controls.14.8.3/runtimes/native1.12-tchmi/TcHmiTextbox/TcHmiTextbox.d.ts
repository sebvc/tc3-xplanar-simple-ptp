...
declare class TcHmiTextbox extends TcHmi.Controls.System.TcHmiControl {
    ...
    __previnit(): void;
    /**
     * Pointer gesture arbitration: the value field is an editable text input or textarea. Take ownership of a
     * left-button drag that starts on it so the user can select its text with the mouse instead of an enclosing
     * zoom/pan region taking the drag over as a pan. A deactivated control disables the input element, so text cannot
     * be selected and the drag is left to the region. Read only is not checked as the text of a read only input is
     * still selectable.
     ...
     * @returns The current value of horizontalScroll.
     */
    getHorizontalScroll(): "Always" | "Auto" | "Never" | undefined;
    /**
     ...
     * @returns The current value of verticalScroll.
     */
    getVerticalScroll(): "Always" | "Auto" | "Never" | undefined;
    /**
