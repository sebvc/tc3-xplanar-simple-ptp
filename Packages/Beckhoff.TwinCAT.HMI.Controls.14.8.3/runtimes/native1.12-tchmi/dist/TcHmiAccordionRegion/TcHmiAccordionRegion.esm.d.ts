...
declare class TcHmiAccordionRegion extends TcHmiControl.Control {
     ...
     */
    protected __getSubRights(items: AccordionItem[], accessList: AccessControl[]): AccessControl[];
    /**
     ...
     */
    protected __onResolverForAccordionItemsWatchCallback(data: ObjectResolver.IWatchResultObject<AccordionItem[] | null>): void;
    /**
