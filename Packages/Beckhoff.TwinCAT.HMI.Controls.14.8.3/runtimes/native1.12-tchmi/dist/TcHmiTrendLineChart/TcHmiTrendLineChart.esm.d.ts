...
declare class TcHmiTrendLineChart extends TcHmiControl.Control {
    ...
    /**
     * Is raised if touchCancel on document. The browser aborts the touch sequence (e.g. gesture takeover, palm
     * rejection or an interrupting system event) without a touchEnd, so clean up any pending tooltip timer and the
     * zoom selection overlay and reset the manipulation state to avoid a stuck pan/zoom.
     * @param event The event of touchCancel.
     */
    protected __onTouchCancel(_event: TouchEvent): void;
    /**
    ...
    getGridLineStyle(): "Dashed" | "Dotted" | "Solid" | undefined;
    ...
    getSubgridLineStyle(): "Dashed" | "Dotted" | "Solid" | undefined;
    ...
    getMouseMode(): "None" | "PanX" | "PanXY" | "ZoomX" | "ZoomXY" | undefined;
