import { Controls, EventProvider, type Keyboard, type Locale, ObjectResolver, TcHmiControl, type DestroyFunction, type FontSizeUnit, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiUserManagement extends TcHmiControl.Control {
    ...
    /** Internal reference to the attribute "data-tchmi-system-keyboard-username-input-mode" */
    protected __systemKeyboardUsernameInputMode: Keyboard.KeyboardInputMode | undefined;
    /** Internal reference to the attribute "data-tchmi-system-keyboard-password-input-mode" */
    protected __systemKeyboardPasswordInputMode: Keyboard.KeyboardInputMode | undefined;
    /**mouse down */
    ...
    /**
     * Sets the value of the member variable SystemKeyboardUsernameInputMode.
     * @param valueNew The new value for SystemKeyboardUsernameInputMode.
     */
    setSystemKeyboardUsernameInputMode(valueNew: Keyboard.KeyboardInputMode | null): void;
    /**
     * Gets the value of SystemKeyboardUsernameInputMode.
     * @returns The current value of SystemKeyboardUsernameInputMode.
     */
    getSystemKeyboardUsernameInputMode(): string | undefined;
    /**
     * Processes SystemKeyboardUsernameInputMode.
     */
    protected __processSystemKeyboardUsernameInputMode(): void;
    /**
     * Sets the value of the member variable SystemKeyboardPasswordInputMode.
     * @param valueNew The new value for SystemKeyboardPasswordInputMode.
     */
    setSystemKeyboardPasswordInputMode(valueNew: Keyboard.KeyboardInputMode | null): void;
    /**
     * Gets the value of SystemKeyboardPasswordInputMode.
     * @returns The current value of SystemKeyboardPasswordInputMode.
     */
    getSystemKeyboardPasswordInputMode(): string | undefined;
    /**
     * Processes SystemKeyboardPasswordInputMode.
     */
    protected __processSystemKeyboardPasswordInputMode(): void;
}
