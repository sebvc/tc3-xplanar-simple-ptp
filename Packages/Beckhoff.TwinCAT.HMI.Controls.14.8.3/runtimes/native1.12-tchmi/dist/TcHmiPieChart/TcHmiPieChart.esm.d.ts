import { Controls, EventProvider, LocalStorage, ObjectResolver, TcHmiControl, type Color, type FontFamily, type FontStyle, type FontWeight, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import { PieChart } from '../TcHmiCharting/PieChart.js';
declare class TcHmiPieChart extends TcHmiControl.Control {
    ...
    /** PieChart element */
    protected __pieChart: PieChart | null;
     ...
     */
    protected __rebuild(_event: EventProvider.Event, ctrl: TcHmiControl.Control): void;
    /**
     ...
     */
    protected __onResolverForPieGraphDescriptionsWatchCallback(data: ObjectResolver.IWatchResultObject<PieGraphDescription[]>): void;
    /**
     ...
     */
    setPieGraphData(valueNew: number[] | null): void;
    /**
     * The watch callback for the pieGraphData object resolver.
     */
    protected __onResolverForPieGraphDataWatchCallback(data: ObjectResolver.IWatchResultObject<number[] | null>): void;
    /**
