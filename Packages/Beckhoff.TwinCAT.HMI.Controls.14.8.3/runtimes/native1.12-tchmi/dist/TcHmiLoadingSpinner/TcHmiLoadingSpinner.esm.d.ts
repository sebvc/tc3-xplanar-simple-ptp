import { Controls, ObjectResolver, TcHmiControl, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiLoadingSpinner extends TcHmiControl.Control {
    ...
    protected __spinnerColor: SolidColor | null | undefined;
     ...
     */
    protected __onResolverForSpinnerColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
    /**
