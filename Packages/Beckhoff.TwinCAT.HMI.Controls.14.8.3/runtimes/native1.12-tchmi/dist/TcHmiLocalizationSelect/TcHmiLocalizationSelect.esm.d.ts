import { Controls, EventProvider, ObjectResolver, TcHmiControl, type Color, type DestroyFunction, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type SolidColor, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiLocalizationSelect extends TcHmiControl.Control {
     ...
     */
    protected __onUserInteractionFinished(_event: EventProvider.Event): void;
    /**
     ...
     */
    protected __onResolverForLocalizationMappingWatchCallback(data: ObjectResolver.IWatchResultObject<ListItem[]>): void;
    /**
