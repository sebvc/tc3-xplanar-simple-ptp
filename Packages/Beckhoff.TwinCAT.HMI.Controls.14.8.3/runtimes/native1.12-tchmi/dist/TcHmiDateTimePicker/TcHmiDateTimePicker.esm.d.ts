...
export declare enum OverrideTimeZone {
...
declare class TcHmiDateTimePicker extends TcHmiControl.Control {
    ...
    /** Holds the data of the date of this.__value in UTC. */
    protected __internalDateObject: Localization.DateParts;
    /** Holds the volatile data of the current editing in UTC. */
    ...
    /**
     * Return the UTC date from UTC date parts.
     */
    protected __getUtcDate(dateObject: Localization.DateParts): Date;
    /**
     * Returns date parts in the configured display timezone from UTC date parts.
     */
    protected __getDisplayParts(utcParts: Localization.DateParts): Localization.DateParts;
    /**
     * Converts display-timezone date parts back to UTC date parts.
     */
    protected __displayPartsToUtcParts(displayParts: Localization.DateParts): Localization.DateParts;
    /**
     ...
     */
    __compareDates(a: string | Date, b: string | Date): -1 | 0 | 1;
    /**
    ...
    static OverrideTimeZone: typeof OverrideTimeZone;
}
...
type tOverrideTimeZone = OverrideTimeZone;
declare global {
    namespace TcHmi.Controls.Beckhoff {
        const TcHmiDateTimePicker: typeof _TcHmiDateTimePicker;
        type TcHmiDateTimePicker = tTcHmiDateTimePicker;
        namespace TcHmiDateTimePicker {
            type OverrideTimeZone = tOverrideTimeZone;
        }
    }
}
