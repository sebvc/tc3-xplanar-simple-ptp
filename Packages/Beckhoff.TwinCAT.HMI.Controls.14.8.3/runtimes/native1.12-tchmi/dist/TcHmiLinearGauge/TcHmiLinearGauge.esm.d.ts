...
declare class TcHmiLinearGauge extends TcHmiControl.Control {
    ...
    /**
     * Pointer gesture arbitration: takes ownership of the press when the gauge is editable and the press starts an
     * edit (on the knob, or on the track/filler when 'clickAnywhereToEdit' is set), so an enclosing zoom/pan region
     * does not take the drag over as a pan. The actual value change is still driven by the existing mouse/touch handlers.
     ...
     */
    getLabelPosition(): "Bottom" | "Left" | "Right" | "Top" | undefined;
    /**
     ...
     */
    getOrientation(): "Horizontal" | "HorizontalInverted" | "Vertical" | "VerticalInverted" | undefined;
    /**
     ...
     */
    getUnitOrientation(): "Horizontal" | "Theme" | "Vertical" | undefined;
    /**
