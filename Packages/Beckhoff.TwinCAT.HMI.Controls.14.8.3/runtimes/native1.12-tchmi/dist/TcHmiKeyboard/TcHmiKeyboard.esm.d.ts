...
declare class TcHmiKeyboard extends TcHmiControl.Control {
    ...
    /**
     * Pointer gesture arbitration: takes ownership of the press when it starts on a key and the keyboard can be
     * operated, so an enclosing zoom/pan region (TcHmiRegion) does not take the press over as a pan. The actual key
     * press is still driven by the existing mouse/touch handlers.
     ...
     */
    getInputHintsValidation(): "DisableAccept" | "HighlightHints" | "None" | undefined;
    /**
