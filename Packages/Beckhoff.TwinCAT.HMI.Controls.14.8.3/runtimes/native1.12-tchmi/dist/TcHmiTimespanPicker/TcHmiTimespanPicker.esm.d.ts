import { Controls, ObjectResolver, Symbol, TcHmiControl, type DestroyFunction, type JsonSchema } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiTimespanPicker extends TcHmiControl.Control {
    ...
    protected __minValueSymbol: string | undefined;
    ...
    /**
     * Returns current value as total milliseconds.
     */
    private __getCurrentMilliseconds;
    /**
     * Normalize milliseconds into a decomposed timespan object.
     */
    private __normalizeMilliseconds;
    /**
     *
     * @param value The value to validate in iso 8601 format
     * @returns value is valid (between min and max) or not
     */
    private __isValid;
    /**
     * Writes a normalized ms value to all spinboxes.
     */
    private __setSpinboxesFromMilliseconds;
    /**
    ...
    private __onPressed;
    /**
     * Is called if onFocusOut event of NumericInput from Spinbox has raised.
     */
    private onFocusOut;
    /**
     * Handles step (plus/minus button press) from any spinbox.
     * Validates against min/max and clamps if necessary.
     */
    private __onSpinboxStep;
    /**
    ...
    protected __onResolverForTimeUnitsWatchCallback(data: ObjectResolver.IWatchResultObject<TimeUnits>): void;
    ...
    protected __onValueSymbolWatch(data: Symbol.IReadResultObject<string>): void;
    protected __processValueSymbol(): void;
    protected __processValueSymbolCurrentValue(): void;
    getMaxValueSymbol(): string | undefined;
    getMinValueSymbol(): string | undefined;
    private setSpinboxesValue;
    protected __setSpinboxesLimit(timespanObject?: {
        years: number;
        months: number;
        days: number;
        hours: number;
