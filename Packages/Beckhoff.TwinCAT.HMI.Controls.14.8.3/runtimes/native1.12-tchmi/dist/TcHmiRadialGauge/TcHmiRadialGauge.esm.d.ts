...
declare class TcHmiRadialGauge extends TcHmiControl.Control {
    ...
    /**
     * Pointer gesture arbitration: takes ownership of the press when the gauge is editable and the press starts on
     * the knob, so an enclosing zoom/pan region does not take the drag over as a pan. The actual value change is still
     * driven by the existing mouse/touch handlers.
