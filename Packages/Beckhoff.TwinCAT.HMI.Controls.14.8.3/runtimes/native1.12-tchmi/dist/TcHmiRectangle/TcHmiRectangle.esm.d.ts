import { Controls, EventProvider, ObjectResolver, TcHmiControl, type Color, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiRectangle extends TcHmiControl.Control {
     ...
     */
    protected __onResized(_event: EventProvider.Event, ctrl: TcHmiControl.Control): void;
