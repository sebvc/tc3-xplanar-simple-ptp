...
export declare class LineAreaGraph extends IGraph {
    ...
    /** Whether the line is drawn as a step line (horizontal to the new x, then vertical to the new y). */
    protected __stepLine: boolean;
    /** The area as Area[]*/
    ...
    /**
     * Inserts corner points into a segment so it is drawn as a step line: horizontally to the
     * new x at the previous y, then vertically to the new y. The returned points are only used
     * for drawing the line and fill, not for dots or tooltips.
     * @param segment The original segment of points.
     * @returns A new array of points including the inserted corner points.
     */
    private getSteppedSegment;
    ...
    /**
     * Sets whether the line is drawn as a step line. When enabled, the line runs horizontally
     * to the new x at the previous y and then vertically to the new y. The inserted corner
     * points are not used for dots or tooltips.
     * @param stepLine Whether the line is drawn as a step line.
     */
    setStepLine(stepLine: boolean): void;
}
