import { Controls, EventProvider, ObjectResolver, Symbol, TcHmiControl, type DestroyFunction, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type HorizontalAlignment, type SolidColor, type ToggleState, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiRadioButton extends TcHmiControl.Control {
    ...
    protected __stateSymbol: Symbol<boolean> | null | undefined;
    /**
    ...
    protected __radioStateIconColor: SolidColor | null | undefined;
    protected __radioStateBackgroundColor: SolidColor | null | undefined;
     ...
     */
    protected __onResolverForRadioStateIconColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForRadioStateBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
