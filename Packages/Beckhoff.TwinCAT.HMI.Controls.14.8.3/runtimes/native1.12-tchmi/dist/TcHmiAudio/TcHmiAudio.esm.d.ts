import { Controls, ObjectResolver, TcHmiControl } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiAudio extends TcHmiControl.Control {
     ...
     */
    protected __onError(event: Event): void;
    /**
     ...
     */
    protected __onResolverForSrcListWatchCallback(data: ObjectResolver.IWatchResultObject<AudioSource[] | null>): void;
    /**
