import { Controls, ObjectResolver, TcHmiControl, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type HorizontalAlignment, type SolidColor, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
