import { Controls, EventProvider, ObjectResolver, TcHmiControl, type DestroyFunction, type SizeModeWithContent } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiVideo extends TcHmiControl.Control {
     ...
     */
    destroy(): void;
    protected __onResized(event: EventProvider.Event, ctrl: TcHmiControl.Control): void;
     ...
     */
    protected __onResolverForSrcListWatchCallback(data: ObjectResolver.IWatchResultObject<VideoSource[]>): void;
    /**
