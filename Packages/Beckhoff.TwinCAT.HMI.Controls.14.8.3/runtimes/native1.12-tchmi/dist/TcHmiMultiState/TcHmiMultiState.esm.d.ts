import { Controls, ObjectResolver, TcHmiControl, type Color, type DimensionUnit, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type SolidColor, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiMultiState extends TcHmiControl.Control {
    ...
    protected __fallbackBackgroundColor: Color | undefined | null;
    ...
    protected __iconHorizontalAlignment: HorizontalAlignment | null | undefined;
    /** Current value of the attribute "data-tchmi-icon-vertical-alignment" */
    protected __iconVerticalAlignment: VerticalAlignment | null | undefined;
    /** Current value of the attribute "data-tchmi-icon-padding" */
    protected __iconPadding: FourSidedCss | null | undefined;
    /**
     ...
     */
    protected __onResolverForStateListWatchCallback(data: ObjectResolver.IWatchResultObject<IStateStructure[] | null>): void;
    /**
     ...
     */
    setFallbackBackgroundColor(valueNew: Color | null): void;
    /**
     * The watch callback for the fallbackBackgroundColor object resolver.
     */
    protected __onResolverForFallbackBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    /**
     * Returns the current value of the member variable FallbackBackgroundColor.
     * @returns the current value of the member variable FallbackBackgroundColor.
     */
    getFallbackBackgroundColor(): Color | null | undefined;
    /**
     ...
     */
    protected __onResolverForTextPaddingWatchCallback(data: ObjectResolver.IWatchResultObject<FourSidedCss>): void;
    /**
     ...
     */
    protected __onResolverForIconPaddingWatchCallback(data: ObjectResolver.IWatchResultObject<FourSidedCss>): void;
    /**
...
export interface IStateStructure {
    state: any;
    stateBackgroundColor: Color | null | undefined;
    stateText: string | null | undefined;
    stateIcon: string | null | undefined;
    stateTextColor: SolidColor | null | undefined;
}
