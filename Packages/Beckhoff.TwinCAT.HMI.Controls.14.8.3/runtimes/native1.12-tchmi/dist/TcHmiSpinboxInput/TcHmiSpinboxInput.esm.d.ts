...
declare class TcHmiSpinboxInput extends TcHmiNumericInput {
    ...
    /** Internal reference to the attribute 'data-tchmi-auto-step-acceleration' */
    protected __autoStepAcceleration: boolean | undefined;
     ...
     */
    protected __executeStep(direction: 'increment' | 'decrement', stepMultiplier?: number): void;
    /**
     * Returns the step multiplier for the current auto step hold.
     * When auto step acceleration is enabled, the step size increases the longer a button is held:
     * a 10 times larger step after 2 seconds and a 100 times larger step after 5 seconds.
     */
    protected __getAutoStepMultiplier(): 1 | 10 | 100;
    /**
    ...
    /**
     * Sets the auto step acceleration attribute and calls the associated process function (processAutoStepAcceleration).
     * @param valueNew The new value for autoStepAcceleration.
     */
    setAutoStepAcceleration(valueNew: boolean | null): void;
    /**
     * Returns the current value of autoStepAcceleration.
     * @returns The current value of autoStepAcceleration.
     */
    getAutoStepAcceleration(): boolean | undefined;
    /**
     * Processes the current autoStepAcceleration attribute value.
     */
    protected __processAutoStepAcceleration(): void;
}
