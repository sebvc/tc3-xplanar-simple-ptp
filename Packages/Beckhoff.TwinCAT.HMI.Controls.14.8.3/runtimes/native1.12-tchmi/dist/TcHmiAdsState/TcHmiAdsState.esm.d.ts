import { Controls, type Locale, ObjectResolver, Server, TcHmiControl } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiAdsState extends TcHmiControl.Control {
     ...
     */
    protected __serverResponseHandler(data: Server.IResultObject<unknown, {
        AdsState: AdsState;
        DeviceState: number;
    }>): void;
    /**
     ...
     */
    protected __onResolverForStateImagesWatchCallback(data: ObjectResolver.IWatchResultObject<IStateImages | null>): void;
    /**
