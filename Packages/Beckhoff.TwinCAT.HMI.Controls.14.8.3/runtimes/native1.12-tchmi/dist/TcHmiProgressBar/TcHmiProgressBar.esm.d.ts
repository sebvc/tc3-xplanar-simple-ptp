import { Animation, Controls, ObjectResolver, TcHmiControl, type Color } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiProgressBar extends TcHmiControl.Control {
    ...
    protected __barColor: Color | null | undefined;
    /**
     ...
     */
    protected __onResolverForBarColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
