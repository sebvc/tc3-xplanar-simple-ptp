import { Controls, EventProvider, ObjectResolver, Symbol, TcHmiControl, type Color, type DestroyFunction, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type HorizontalAlignment, type SolidColor, type ToggleState, type VerticalAlignment } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiCheckbox extends TcHmiControl.Control {
    ...
    protected __toggleStateIconColor: SolidColor | null | undefined;
     ...
     */
    protected __onResolverForToggleStateIconColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor | null>): void;
    /**
     ...
     */
    protected __onResolverForTextBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color | null>): void;
    /**
