import { EventProvider, Server, type TcHmiControl, type UiProvider, type DestroyFunction, type Dictionary, type IErrorDetails, type JsonSchema, type Localizable } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
 ...
 */
export declare class InteractiveWritePrompt extends OkCancelPrompt<UiProvider.PopupProvider.InteractiveWritePrompt.Value, UiProvider.PopupProvider.InteractiveWritePrompt.Value> {
    /**
    ...
    protected __options: UiProvider.PopupProvider.InteractiveWritePrompt.Options | null;
    protected __symbolName: string | null;
    protected __schema: JsonSchema | null;
    ...
    protected __result: Server.IValueResultObject | undefined;
