import { type Comparison, type DestroyFunction, type Filter, type JsonSchema, Locale, type LogicOperator, type TcHmiControl } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
