...
declare class TcHmiCalculator extends TcHmiControl.Control {
    ...
    /**
     * Pointer gesture arbitration: takes ownership of a left-button drag that starts on the result input so the user
     * can select its text with the mouse instead of an enclosing zoom/pan region taking the drag over as a pan.
