...
declare class TcHmiButton extends TcHmiControl.Control {
    ...
    /**
     * Pointer gesture arbitration: takes ownership of the press when the button can be operated, so an enclosing
     * zoom/pan region (TcHmiRegion) does not take the press over as a pan. The actual press is still driven by the
     * existing mouse/touch handlers.
