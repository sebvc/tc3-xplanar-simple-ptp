import { type BindingMode, Controls, EventProvider, type Locale, ObjectResolver, Server, Symbol, type SymbolExpression, TcHmiControl, TimedAsyncTask, type BorderStyle, type Color, type DestroyFunction, type DimensionUnit, type Filter, type FontFamily, type FontSizeUnit, type FontStyle, type FontWeight, type FourSidedCss, type HorizontalAlignment, type IErrorDetails, type JsonSchema, type SolidColor, type SortingInfo, type VerticalAlignment, type IFunction } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiObjectBrowser extends TcHmiControl.Control {
    ...
    protected __bindingMode: BindingMode;
     ...
     */
    protected __transformDataAndDataSchema(data: any, name: string, schema: JsonSchema, timedAsyncTask: TimedAsyncTask): Promise<ITransformationResult>;
    /**
