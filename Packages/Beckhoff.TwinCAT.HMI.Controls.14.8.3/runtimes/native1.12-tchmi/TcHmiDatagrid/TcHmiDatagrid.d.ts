...
declare class TcHmiDatagrid extends TcHmi.Controls.System.TcHmiControl {
    ...
    __previnit(): void;
    /**
     * Pointer gesture arbitration: the datagrid builds its own cell editor inputs (text box, numeric, spinbox,
     ...
     * pan. Checkboxes and other non-text inputs are ignored.
     ...
     */
    getSrcColumn(): Column[] | SimpleColumn | undefined;
    /**
