...
declare class TcHmiRecipeEdit extends TcHmi.Controls.System.TcHmiControl {
    ...
    protected __onRecipeListReceivedManager: Callback.Collection<(rootDirectory: Server.RecipeManagement.FolderRecipe | null) => void>;
    ...
    protected __clipboard: {
        action: 'cut' | 'copy';
        origin: string[];
        items: DirectoryBrowser.DescendantItem<Server.RecipeManagement.Recipe, Server.RecipeManagement.FolderRecipe>[];
    } | null;
    protected __recipeBrowser: DirectoryBrowser<Server.RecipeManagement.Recipe, Server.RecipeManagement.FolderRecipe> | undefined;
     ...
     */
    protected __copyPaste(itemsToPaste: Map<string, DirectoryBrowser.DescendantItem<Server.RecipeManagement.Recipe, Server.RecipeManagement.FolderRecipe>>, target: string[]): void;
    /**
     ...
     */
    protected __cutPaste(itemsToPaste: Map<string, DirectoryBrowser.DescendantItem<Server.RecipeManagement.Recipe, Server.RecipeManagement.FolderRecipe>>, origin: string[], target: string[]): void;
    /**
     ...
     */
    __registerOnRecipeListReceived(callback: (rootDirectory: Server.RecipeManagement.FolderRecipe | null) => void): () => void;
    /**
...
export declare class SelectRecipePrompt extends OkCancelPrompt<{
    ...
    #private;
    protected __parentControl: TcHmiControl.Control;
    protected __recipeBrowser: DirectoryBrowser<Server.RecipeManagement.Recipe, Server.RecipeManagement.FolderRecipe>;
