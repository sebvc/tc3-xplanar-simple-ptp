...
declare class TcHmiObjectBrowser extends TcHmiControl.Control {
     ...
     */
    protected __originalIndexToDataSchema(schema: TcHmi.JsonSchema, index: number[]): import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").JsonSchema;
    /**
     ...
     * @returns the current value of the member variable dataSchema.
     */
    getDataSchema(): import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").JsonSchema | undefined;
    /**
