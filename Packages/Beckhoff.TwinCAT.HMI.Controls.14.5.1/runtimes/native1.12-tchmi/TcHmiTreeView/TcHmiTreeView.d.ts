...
declare class TcHmiTreeView extends TcHmi.Controls.System.TcHmiControl {
     ...
     */
    protected __dataToFilteredSortMap(data: TcHmiDatagrid.PagedArray<any> | any[], index?: number[]): import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").HierarchicalFilterMap[];
    /**
    ...
    protected __getColumnControlInfoByEditorInfo(editorInfo: Editor.EditorInfo | undefined): {
        ...
        editable: boolean;
        schema: import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").JsonSchema | undefined;
    };
    /**
     ...
     * @returns the current value of the member variable dataSchema.
     */
    getDataSchema(): import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").JsonSchema | null | undefined;
    /**
