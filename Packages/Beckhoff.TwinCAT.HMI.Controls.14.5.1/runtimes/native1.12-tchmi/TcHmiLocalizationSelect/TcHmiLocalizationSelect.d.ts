...
declare class TcHmiLocalizationSelect extends TcHmi.Controls.System.TcHmiControl {
     ...
     */
    protected __onUserInteractionFinished(_event: TcHmi.EventProvider.Event): void;
    /**
     ...
     */
    protected __onResolverForLocalizationMappingWatchCallback(data: TcHmi.ObjectResolver.IWatchResultObject<ListItem[]>): void;
    /**
