...
declare class TcHmiUserControlHost extends TcHmi.Controls.System.TcHmiControl {
    ...
    __processTargetUserControl(): void;
    protected __processTargetUserControl_Parameter(): void;
    protected __processTargetUserControl_Markup(): void;
    /**
...
export interface IScopedMarkupResultObject extends IResultObject {
    markup?: string;
}
