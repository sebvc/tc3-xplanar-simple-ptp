...
declare class TcHmiBreadcrumb<ContentType = string> extends TcHmiControl.Control {
    ...
    protected __buttonDestroyFunctions: Map<Element | Document | Window | Iterable<Element>, Map<string, import("Beckhoff.TwinCAT.HMI.Framework/index.esm.js").DestroyFunction>>;
    /**
