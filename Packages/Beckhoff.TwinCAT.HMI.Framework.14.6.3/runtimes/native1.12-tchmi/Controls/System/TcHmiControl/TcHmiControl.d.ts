...
declare class TcHmiControl extends baseTcHmiControl {
    ...
    __previnit(): void;
    /**
     * Pointer gesture arbitration hook. Return true on a pointerdown to take ownership of the drag for this control so
     * an enclosing zoom/pan region (TcHmiRegion) does not take it over as a pan. The default returns false (the control
     * does not own drags; a region may pan when a drag starts on it). Override in drag-owning controls (e.g. sliders).
     * @param _event The pointerdown event.
     */
    protected __ownsPointerDrag(_event: PointerEvent): boolean;
    /**
     ...
     * @preserve (Part of the public API)
     */
    getWidthMode(): "Content" | "Parent" | "Value" | undefined;
    /**
     ...
     * @preserve (Part of the public API)
     */
    getHeightMode(): "Content" | "Parent" | "Value" | undefined;
    /**
