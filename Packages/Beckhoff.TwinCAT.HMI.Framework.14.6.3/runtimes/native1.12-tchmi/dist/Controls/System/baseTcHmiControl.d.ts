...
export declare abstract class baseTcHmiControl extends Destroyable {
     ...
     * If this is a container control it will append child's DOM element to the container DOM at the correct place.
    ...
    /**
     * Ensures that every registered object resolver of an attached control has a live watch.
     * Idempotent: resolvers that already have a watch are left untouched.
     * @preserve (Part of the public API)
     */
    abstract __ensureObjectResolversWatched(): void;
    /**
     * AccessConfig
     * @preserve (Part of the public API)
     */
