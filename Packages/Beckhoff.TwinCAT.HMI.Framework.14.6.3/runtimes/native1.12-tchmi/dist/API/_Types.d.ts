...
export interface IConfig {
    ...
    /** Settings for the parser of function expressions and bindings. */
    expressionJsParser?: {
        /**
         * ECMAScript version the expression javascript parser targets.
         * Defaults to 'latest'. Pin to a specific version (e.g. 2022) to keep the accepted syntax
         * stable, or to fall back to an older grammar if a newer default causes problems.
         */
...
export interface ControlDescription {
    ...
    displayName?: string;
    version: Version;
    /** Determine if a control is shown to the user. Defaults to true. */
    visible?: boolean;
...
export interface ControlEventDescription extends baseEventDescription {
    /** Determine if an event is shown to the user. Defaults to true. */
    visible?: boolean;
    heritable: boolean;
...
export interface ControlFunctionDescription {
    ...
    /** Name which should be presented the user. */
    displayName?: string;
    /** Determine if a function is shown to the user. Defaults to true. */
    visible?: boolean;
    ...
    params?: {
        ...
        bindable: boolean;
        /** Determine if a parameter is shown to the user. Defaults to true. */
        visible?: boolean;
    }[];
...
export interface FunctionDefinition {
    ...
    description: string;
    category: string;
    /** Determines if the function is shown to the user. Defaults to true. */
    visible?: boolean;
...
export interface ControlAttributeDescription {
    ...
    /** Name which should be presented the user. */
    displayName?: string;
    /** Determine if an attribute is shown to the user. Defaults to true. */
    visible?: boolean;
    ...
    /**
     * When true, a Binding to this attribute hands over its TcHmi.Symbol instance instead of writing the resolved
     * value, even though the attribute is of a raw type. The setter keeps carrying raw values only. The reference
     * is delivered on the '<controlId>.onAttributeSymbolReferenceChanged' event (payload: propertyName and symbol,
     * with a null symbol on release), and the control owns reading, writing and metadata for it.
     */
    bindableAsRef?: boolean;
    /**
