...
export declare namespace SymbolExpression {
    ...
    interface IOptions {
        ...
        UniqueHash?: boolean;
        /**
         * When set to true, subscription updates that the server processed before this consumer's latest write are
         * dropped, so a value from before the write is never surfaced after it (e.g. a stale cyclic-poll tick or a
         * value that was reset within the same PLC cycle). Determined via the processed timestamps of the write
         * response and the subscription tick, never by trusting the written value.
         * Only respected in case of a symbol expression of type Server.
         */
        IgnoreOutdatedValues?: boolean;
        /**
         ...
         *          Some interpreters like System.Binding will extend the meaning of Value in this case and resolve the final value instead of the reference holding that value,
         *          when they know that a generic value and not a symbol reference is expected on the other end.
         */
