...
/**
     ...
     * @preserve (Part of the public API)
     */
watch(callback){this.__symbol||(this.__symbol=new SystemSymbol(this.__expression)),this.__symbolRefCount++;let destroy=this.__symbol.watchExpression(callback);return()=>{destroy(),this.__symbolRefCount--,0===this.__symbolRefCount&&(this.__symbol?.destroy(),this.__symbol=void 0)}}}