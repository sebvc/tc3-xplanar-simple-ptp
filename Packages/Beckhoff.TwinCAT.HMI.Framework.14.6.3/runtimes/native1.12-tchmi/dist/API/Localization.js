...
/**
     ...
     * @preserve (Part of the public API)
     */
function(date,options){if(isNaN(date.getTime()))return null;const locale=options?.locale??void 0,timeZone=options?.timeZone,format=options?.type;return getDateTimeFormatter(locale,timeZone,void 0,format).format(date)}}(Localization||(Localization={}));